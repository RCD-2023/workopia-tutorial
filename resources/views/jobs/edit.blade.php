<x-layout>
  ...
  <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
    ...
    <!-- Form Start -->
    <form
    {{-- In laravel putem sa mentinem POST. Usiual ar trebui PUT --}}
      method="POST" 
    ...
    >
      ...
      <x-inputs.text id="contact_phone" name="contact_phone" label="Contact Phone" type="text" " placeholder="Enter phone" :value="old('contact_phone',$job->contact_phone)" />
