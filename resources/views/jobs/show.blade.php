...
@can('update',$job)
            ...
            <a
                ...
                >Edit</a>
            {{-- <!-- Delete Form !! se lucreaza cu formular !!--> --}}
            <form method="POST" 
...
@endcan
    ...
    <div class="container mx-auto p-4">
        ...
        {{-- Trigger pentru modal completare aplicatie cu Alpinejs --}}
...
@else
<p class="my-5 bg-gray-300 text-red-500 font-bold rounded-xl p-3">
...
@endauth
    ...
    <div class="bg-white p-6 rounded-lg shadow-md mt-6">
      ...
      <p class="text-gray-700 text-lg mt-2">Phone: {{$job->contact_phone}}</p>
                    @endif
        <!-- Bookmark Button -->
                    @guest
    <p class="mt-10 bg-gray-200 text-gray-700 font-bold 
    w-full py-2 px-4 rounded-full text-center">
  <i class="fas fa-info-circle mr-3"></i> 
  You must be logged in to bookmark this job.</p>
        @else
